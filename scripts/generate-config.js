...
// Hardcodeamos la URL de Render como fallback para asegurar que funcione el despliegue
const DEFAULT_API_URL = 'https://proyect-web-ii-backend.onrender.com';
let API_BASE_URL = process.env.API_BASE_URL || DEFAULT_API_URL;
